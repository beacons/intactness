...
#### Case Study 2b - Harvesting in British Columbia
...
kable(x, align=c('l','c','c','c','c','c','c'),caption='**Table 1**. Area omitted by each intactness map in the British Columbia study area.')
```
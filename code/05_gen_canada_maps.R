...
maps = c('ha2010','cifl2000','cifl2013','gifl2000','gifl2013','gifl2016','hfp2000','hfp2013','ab2000','ab2015','ghm2016','vlia2015','ff1996')
...
for (i in maps[13]) {
    ...
    tmap_save(map, filename=paste0('maps/ca_',i,'.png'), height=1260, width=2100)
}

...
maps = c('ha2010','cifl2000','cifl2013','gifl2000','gifl2013','gifl2016','hfp2000','hfp2013','hfp2019','ab2000','ab2015','ghm2016','vlia2015','ff1996')

can1 = readRDS("data/gadm/gadm36_CAN_1_sf.rds")
can = st_transform(can1, prj) %>% ms_simplify() %>% st_make_valid()

borealDir = 'data/boreal/'
...
for (i in maps) {
    ...
    tmap_save(map, filename=paste0('supp/maps/ca_',i,'.png'), height=1260, width=2100)
}

...
maps = c('gifl2016','hfp2013','ab2015','ghm2016','vlia2015')
ak1 = readRDS("2_cover/gadm/gadm36_USA_1_sf.rds")
ak1 = readRDS("2_cover/gadm/gadm36_USA_1_sf.rds") %>% filter(NAME_1=="Alaska")
ak = st_transform(ak1, prj) %>% ms_simplify() %>% st_make_valid()

borealDir = 'C:/Users/PIVER37/Documents/gisdata/intactness/boreal_ak/'
...
for (i in maps) {
    ...
    tmap_save(map, filename=paste0('../supp_info/maps/ak_',i,'.png'), height=1260, width=2100)
}
